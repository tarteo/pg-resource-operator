...
import (
	...
	"github.com/tarteo/pg-resource-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e5787aff.onestein.nl",
	...
	if err := (&controller.PostgresRoleMembershipReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "PostgresRoleMembership")
		os.Exit(1)
	}
